...
export function displayDate(v){
 if(!/^\d{4}-\d{2}-\d{2}$/.test(String(v)))throw Error('Invalid editorial date');
...
function shell(title,description,path,content,review,schema=''){
 return `<!doctype html><html lang="en-IN"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${E(title)} | MarketDeck</title><meta name="description" content="${E(description)}"><meta name="theme-color" content="#080c12">${review?'<meta name="robots" content="noindex, nofollow">':`<link rel="canonical" href="${ORIGIN+path}">`}<meta property="og:type" content="article"><meta property="og:title" content="${E(title)}"><meta property="og:description" content="${E(description)}"><meta property="og:url" content="${ORIGIN+path}"><link rel="icon" href="/favicon.png" type="image/png" sizes="192x192"><link rel="apple-touch-icon" href="/apple-touch-icon.png"><link rel="stylesheet" href="/home.css?v=brand-20260926"><link rel="stylesheet" href="/intelligence-article-v1.css?v=brand-20260926">${schema}</head><body class="md-article"><a class="skip-link" href="#reading">Skip to article</a><header class="a-header"><a class="a-brand" href="/" aria-label="MarketDeck home"><img class="brand-icon" src="/assets/marketdeck-mark.png" width="32" height="32" alt="" aria-hidden="true"><span class="brand-wordmark">Market<span class="brand-deck">Deck</span></span></a><nav aria-label="Editorial navigation"><a href="/intelligence/">Intelligence</a><a href="/intelligence/library/">Library</a><a href="/intelligence/issues/">Magazine archive</a><a href="/#products">The suite ↗</a></nav></header>${content}<footer class="a-footer"><span>MarketDeck · Research and education. Not investment advice.</span><a href="/intelligence/methodology/">Calculation methodology</a><a href="/intelligence/editorial-policy/">Editorial standards</a><a href="/intelligence/">All perspectives ↗</a></footer></body></html>`;
}
